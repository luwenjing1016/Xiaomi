    ...
    <div class="top center">
        ...
        <div class="right fr">
            ...
            <div class="fr">
                <ul>
                    @if($uname)
                        <li><a href="./selfInfo" target="_self" >{{$uname}}</a></li>
                        <li><a href="./loginout?uname={{$uname}}" target="_self" >退出登录</a></li>
                    @else
    ...
    <div class="nav">
        <ul>
            @foreach($menus as $key=>$menu)
                <li>
                    @foreach($menu['types'] as $kk => $value)
                        <a href="./liebiao?type={{$value}}">{{$value}}</a>
                            <div class="pop">
                                @foreach($menu['goods'] as $k => $v)
                                        <div class="left fl">
                                            <div>
                                                <div class="xuangou_left fl">
                                                    <a href="">
                                                        <div class="img fl"><img src="{{$v['timg']}}" alt=""></div>
                                                        <span class="fl">{{$v['tname']}}</span>
                                                        <div class="clear"></div>
                                                    </a>
                                                </div>
